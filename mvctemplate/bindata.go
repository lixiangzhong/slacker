...
func serviceTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "service.tpl", size: 3321, mode: os.FileMode(420), modTime: time.Unix(1590455960, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
